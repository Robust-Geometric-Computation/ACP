...
// Binary operators
template <class T>
inline __device__ bool operator<(interval_gpu<T> const& x,
                                 interval_gpu<T> const& y) {
  return x.upper() < y.lower();
}

template <class T>
inline __device__ bool operator<(T const& x, interval_gpu<T> const& y) {
  return x < y.lower();
}

template <class T>
inline __device__ bool operator<(interval_gpu<T> const& x, T const& y) {
  return x.upper() < y;
}
...
template <class T>
inline __device__ interval_gpu<T> operator+(T const& x,
                                            interval_gpu<T> const& y) {
